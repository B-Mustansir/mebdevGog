      ...
      <div class="table-responsive">
        <table border="2" width="100%" cellspacing="0" bgcolor="">
          <tr>
            ...
            <td class="id2">Image</td>

            <td class="id2">Status</td>
  ...
  $selectquery = "select * from reports ";
          ...
          ?>
            <tr>
              ...
              <td class="id"><a href="<?php echo $res['file']; ?>">Click here</a></td>
              <td class="id">
              <?php 
              if($res['resolve']=='0')
{?><a href="resolved.php?id=<?php echo$res['id'];?>"> Resolve </a></td>
<?php
...
<script type="text/javascript">
  ...
  {
     window.location = "test1.php?sortby="+elm.value;
  }
</script>
