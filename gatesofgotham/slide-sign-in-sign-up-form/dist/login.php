...
if(isset($_SESSION['username'])){
	...
	<div class='nav'>
		<div class='logo'> 
			<h1 style="  font-family: 'Courier New', Courier, monospace;">ADMIN PORTAL</h1> 
		</div>
		<div class='btn'>  
	...
	<div class="main">
		...
		<span class="view">
			<a href="http://localhost/techie/gatesofgotham/table-responsive/dist/table.php">View Complaints</a>
		</span>
	</div>
