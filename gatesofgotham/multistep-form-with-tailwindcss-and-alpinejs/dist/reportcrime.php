...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Multistep Form with TailwindCSS and AlpineJS</title>
		...
		<div class="max-w-3xl mx-auto px-4 py-10">
			...
			<div x-show.transition="step != 'complete'">	
				...
				<div class="py-10">	
					...
					<div class="mb-5">
							<label for="firstname" class="font-bold mb-1 text-gray-700 block">Name</label>
							<input type="text"
								class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
								placeholder="Enter your name..." name="name1">
						</div>
...
if ($_GET['submit']) {
    ...
    $query = "insert into reports (name,email) values('$name1','$email')";
